...
How did the markets' assesment of war risk change leading up to the war? 
And which events were most important in changing the markets' risk assessment the most?
Using the prices and yields of U.S. government and state bonds traded in New York, this section answers these questions using the yields of these bonds, the spread between northern and southern state bond yields, and calculations of the implied probability of war.
The story that emerges from these analyses are that the market saw no or negligible risk of war prior to the election of Lincoln in November 1860, and although the market recognized and responded to the increased risk of war between Lincoln's election and the start of the war with the battle of Fort Sumter, the implied risk of war was still quite low.

To assess the financial market beliefs about the American Civil War, this paper uses the prices and yields of U.S. government and state, both northern and southern, bonds traded in New York City from 1855-1861.
...
The set of bonds included here are those with regular, weekly quotations in the \texttt{Bankers' Magazine}, one of the leading trade magazines of that era.
All of these bonds are coupon bonds with longer maturities.
The bonds in the data paid between 5-6 percent per annum semi-annually.
...
%% }
The 6s of 1868 and the 5s of 1874 were the two major bond issues of the U.S. prior to the civil war. 
Between the War of 1812 and the Civil War, the U.S. government only periodically issued debt and thus there were few regularly traded government bonds.
ADD CITATION
...
During the ante-bellum period, most New England states did not issue debt, Massachusetts was the notable exception.
\footnote{
...
Although state bonds were generally considered safer assets than corporate bonds during this period, they were still seen as risky due to defaults of state bonds in the 1840s \parencites{English1996}[320-321]{HomerSylla2005}
...
The Panic of 1857 was a recession and financial crisis that included the failure of a major insurance company, the bankruptcy of several railroads in the west and midwest, and the suspension of specie payments by banks in New York City. 
...
\end{quote}
Over the following months, yields stayed high and were variable \parencites[718]{HuntKettellHomansEtAl1860}[78,198,416,677]{HomansDana1861a}[413,481,669,756,838]{BankersMagazine1861}.
...
In their April issues, the \textit{Bankers' Magazine} wrote
\begin{quote}
...
\end{quote}
and \textit{Merchants' Magazine} wrote
\begin{quotation}
