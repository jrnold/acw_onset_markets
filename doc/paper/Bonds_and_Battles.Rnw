...
This section answers these questions using data on the prices and yields of U.S. government and state bonds between 1855 and the start of the war at the Battle of Fort Sumter in April 1861.
...
From these data, up until the the election of Lincoln in November 1860, bond prices implied neglible to no risk of war.
After the election the markets' beliefs about the risk of war increased. 
However, although the markets' beliefs about the probability of war had increased, they believed that war would probably not occur.
...
\footnote{
  ...
  The particular dataset used in this section is \href[bankers_magazine_govt_state_loans_yields_2.csv]{https://github.com/jrnold/civil_war_era_findata/blob/master/data/bankers_magazine_govt_state_loans_yields_2.csv}.
}
...
So although yields reached high levels the panic, this is due to financial reasons and not increased expectations of war.
...
\footnote{The money market sections of the \textit{Bankers' Magazine} do not mention domestic political issues during the Panic of 1857, but attribute it to a decline in foreign trade and bad banking.}
...
Although Louisiana, North Carolina and Tennessee did not seceed and join the Confederacy until after Fort Sumter, the yields on those bonds increased during this period.
