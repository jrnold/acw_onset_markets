...
After Lincoln won the election in November 1860, yields started to increase, for some bonds, quickly and sharply.
  The election of Lincoln in 1860 precipitated a financial crisis. 
  Southern banks withdrew specie from the North.
  Although in many cases the yields after the Panic of 1857 were still lower than those in 1857.

The election of 1860 was followed by a financial crisis, precipiated by Southern banks denying credit to Northern merchants and investors and withrawing specie from the North.
\begin{quote}
...
\footnote{
The November 1860 \textit{Bankers' Magazine} wrote,
\begin{quote}
...
There was some 
\begin{quote}
  The continued contraction of the banks, and the decrease in the specie reserve, caused some activity in the money market in the beginning of the month...
\end{quote}
}
