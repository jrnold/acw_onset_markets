...
This paper looks at how soveign bonds can be used to derive the \textit{ex ante} probability of war as well as the 

\begin{itemize}
\item Several papers have looked at the relationship between battles and the prices of Union and Confederate currency during the American Civil War \cite{Mitchell1903}{WillardGuinnaneEtAl1996}{McCandless1996}{SmithSmith1997}{BrownBurdekin2000}{Weidenmier2002}.
  This paper differs from them in that it analyzes war the initiation of the American Civil War and uses different assets, state bonds as opposed to currency.
\item This paper is most similar \cite{HaberEtAl2012} which uses a cash flows of assets in the American and Chinese Civil Wars to predict the probability of defeat. Probability of war ex ante, tying itto the discussion of theories of war, estimating war initiation instead of war termination, using non-zero recovery rates, and using multiple assets to gain leverage in predicting the probability of war.  
\item \textcites{LeighWolfersEtAl2003}{WolfersZitzewitz2009} uses prediction markets as a measure of the ex ante probability of the initiation of the Iraq War in 2003.
\item Other papers have looked at the relationship between prices and political events ...
\end{itemize}

This paper also discusses how asset prices potentially provide a empirical means for international relations to disentangle rationalist theories of war (bargaining model of war) \cite{Fearon1995}{Reiter2003}{Powell2006}.
Different theories of war have 
...
Historically, the U.S. had paid for wars with debt.
The U.S. notably issued debt to fund the War of 1812, to which the debt issued during the was compared to by investors \parencite[8 pp.]{BankersMagazine1862}.
And the 6s of 1868, one of the U.S. bonds in the data, were issued during the Mexican-American War (1846--1848).

A war would influence the credit of the issuers of bonds through increased debt, decreased revenue or default, and contemporary investors were aware of these risks.
...
For the holders of southern state bonds, the immediate concern was statutory default.
After the initiation of the war, southern states ceased interest payments to nothern creditors starting with the July 1861 coupon payments \parencite[947]{BankersMagazine1861}[159]{BankersMagazine1862}.
Investors almost certainly anticipated this as, although the Southern states paid interest on time in January 1861, there was uncertainty about this \parencite[756]{BankersMagazine1861},
\begin{quote}
  The currency troubles in the West had undoubtedly an effect in producing the decline [in the price of Virginia, Tennessee and Missouri bonds]  which was further stimulated by the political condition of the country and doubts as to the prompt payment of interest by these States.
\end{quote}
After Fort Sumter, that was the reason cited for southern state decline, ``These low values [prices of southern state bonds] have partly been caused by the fear that these States will not be disposed to provide for the payment of their semi annual interest in July next'' \parencite[947]{BankersMagazine1861}. 
By November 1861,  ``...but faint hopes are entertained of their paying their interest for some years to come.'' \parencite[559]{BankersMagazine1862}.
When the states formally suspended interest payments, the market was not surprised \parencite[159]{BankersMagazine1862}
Additionally, although at first the ability of the states to pay their debt was not at issue, a war would result in more debt issued and wealth destroyed, which could affect the ability of the states to pay.

After the war, most Southern state repaid the debt issued before the war, although they defaulted on all debt issued during the war and several states defaulted on debt issued by reconstruction governments before 1870 \parencite{Randolph1931}{Ratchford1941}.
It is unclear what would have happened to this debt if the Confederacy had won the war; at best, the states would return to paying interest and principal on those debts; at worst, they would default on nothern creditors.
...
Thus, holders of southern state bonds were particularly exposed to war risk, and almost certain to suffer losses immediately at the start of a conflict between the states.

Thus, although U.S. government bonds and state bonds were not direct prediction markets, a war would affect the cashflows of debt issued by states and the government and investors were aware of this. 
...
Section \ref{sec:model-probability-war} statistically disentangles these two effects, but informally, it is unlikely that beliefs about what a war between the northern and southern states would look like are changing before the American Civil War than that beliefs that the probablility that such a war would occur.
This is n
...
PRWAR_18601207 <-
    round(filter(prwar2_summary$phi, date == as.Date("1860-11-16"))$mean, 3)
...
\footnote{To account for differences in bond prices over time due to changes in maturity, the $R_{t}$ for each bond is the present value of the bond at time $t$ calculated using the average yield to maturity from the period after the start of the war.}
...
With the election of Lincoln and the ensuing financial crisis, the probability of war jumped from \Sexpr{PRWAR_18601123} to \Sexpr{PRWAR_18601207}.%
