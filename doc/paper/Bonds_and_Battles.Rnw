...
\newcommand{\subtitle}{Did the Financial Market \\Anticipate the Onset of the American Civil War}
...
The spread (difference) between the average yields of southern and northern state bonds is another measure of market beliefs about war risk.
War would, and did, increase the risk of southern bonds relative to northern bonds.%
\footnote{
...
The most immediate differential effect of the war on southern state bond holders in the north was that the states stopped paying interest payments \parencites[974]{BankersMagazine1861}[159,479]{BankersMagazine1862}.%
\footnote{It seems that after the war, southern states repaid debt issued \textit{before} the war in some manner; though all defaulted on any debts issued while part of the Confederacy, and some defaulted on debt issued by reconstruction governments after the war. }
Using this spread rather than raw yields has the advantage of controlling for factors which have the same influence on all state bonds.
For example, as noted below, yields spiked during the Panic of 1857, but the spread between southern and northern bonds did not spike.
There may still be fundamental differences between the risks of northern and southern states due to many reasons, but focusing on changes in the spread controls for any of these factors which are constant over the time period considered.
It is likely that war risk would be the most influential factor influencing the spread.

The data used to calculate the spread consists of the yields of northern (Indiana, Ohio and Pennsylvania) and southern (Georgia, Louisiana, North Carolina, Tennessee and Virginia) bonds for the full period.%
\footnote{The border states of Kentucky and Missouri are not included in these calculations.}
The model used to estimate spread is described in section \ref{sec:model-south-north-yield-spreads}.
Figure \ref{fig:yields_regions} plots the yields of northern and southern bonds while Figure \ref{fig:north_south_spreads} plots the difference between the mean yields of southern and northern state bonds as estimated with the model described in section \ref{sec:model-south-north-yield-spreads}.

Over the entire period considered here, the spread was positive, meaning that southern state bonds were riskier on average than northern state bonds.
\footnote{That southern bonds have a higher risk premium during this period is somewhat surprising givne the northern bonds; two of the three northern state bonds (Indiana, Pennsylvania) had defaulted in the 1840s.}

The spread at the start of the data was ...
The spread jumped ... percentage points in November 1856.
The reasons for this jump are unclear.
It corresponds with the election of James Buchanan.
However, the money market sections of the *Bankers' Magazine* make little mention of any events influencing the market of state bonds.
From July 1856 to January 1860, the spread was stable, with a median of ....

The spread trended slightly upward during 1860, ...
In October, 
The spread jumps after the election of Lincoln.
From ... to ..., the spread between Southern and Northern bonds increased.

However, immediately before Fort Sumter, the spread was ... percentage points.
After Fort Sumter, this would increase to ... to ... percentage points.

Thus analysis of the spread between southern and northern bonds have similar implications as the yields.
There were few changes in war risk prior to the election of 1860.
The market responded to the election. 
The spreads suggest that war risk is increasing during the period leading up to Sumter.
However, the spread is much lower than would be observed after Fort Sumter, implying that the start of the war was unexpected.
...
The market's beliefs about the probability of war can be inferred from bond prices by treating war as a default event.
