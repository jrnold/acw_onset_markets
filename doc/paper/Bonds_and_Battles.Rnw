...
Note that this does not completely isolate war risk, as there are potentially other factors which could have differential effects, but in this period they are less likely and less prominent than war risk.
...
The most immediate differential effect of the war on southern state bond holders in the north was that the states stopped paying interest payments \parencites{}.%
...
This difference can be due to a number of fundamental factors rather than risk.%
\footnote{This is somewhat surprising because two of the three northern state bonds (Indiana, Pennsylvania) had defaulted in the 1840s.}
