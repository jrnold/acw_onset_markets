...
This paper contributes to the literature analyzing the relationship between conflict events \textit{within} and prices. 
THis includes a multiple papers on reactions of the financial markets on both sides and Europep to the American Civil War \textcites{Schwab1901}{Mitchell1903}{WillardGuinnaneEtAl1996}{McCandless1996}{SmithSmith1997}{BrownBurdekin2000}{Weidenmier2002}.
...
CITE OTHER PAPERS of political events
This paper adds to the surpisingly small but growing international relations literature that uses the American Civil War as a case \textcite{Reiter2009}.
...
The price of generic bond is present discounted value of \textit{future} cash flows.
Since the value of the bond depends on an uncertain future, the current price of a bond is effectively a quantitative summary of investors' beliefs about the future.

To be able to use a bond, or other financial asset, to make inferences about how beliefs about a war are changing over time (1) future payments from that asset must be contingent directly or indirectly on the war, and (2) confounding factors affect the future payments must be controlled for. 
