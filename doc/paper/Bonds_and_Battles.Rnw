...
spreads_1855 <-
    filter(spreads_summary$theta,
           ...
           dimension == 2)
spreads_1855_fmt <- format_spreads(spreads_1855$value_mean,
...
spreads_preelec <-
    filter(spreads_summary$theta,
           ...
           dimension == 2)
spreads_preelec_fmt <- format_spreads(spreads_preelec$value_mean,
...
spreads_postelec <-
    filter(spreads_summary$theta,
           ...
           dimension == 2)
spreads_postelec_fmt <- format_spreads(spreads_postelec$value_mean,
...
spreads_presumter <-
    filter(spreads_summary$theta,
           ...
           dimension == 2)
spreads_presumter_fmt <- format_spreads(spreads_presumter$value_mean,
...
spreads_postsumter <-
    filter(spreads_summary$theta,
           date == as.Date("1861-04-13"),
           dimension == 2)
spreads_postsumter_fmt <- format_spreads(spreads_postsumter$value_mean,
...
spreads_diff_1855_elec <-
    filter(spreads_summary$theta_diff_18550713_18601102,
           dimension == 2)
spreads_diff_1855_elec_fmt <- format_spreads(spreads_diff_1855_elec$mean,
...
spreads_diff_sumter <-
    filter(spreads_summary$theta,
           ...
           dimension == 2)
spreads_diff_sumter_fmt <- format_spreads(spreads_diff_sumter$diff_mean,
...
spreads_diff_elec <-
    filter(spreads_summary$theta_diff_elec,
           dimension == 2)
spreads_diff_elec_fmt <- format_spreads(spreads_diff_elec$mean,
...
\begin{figure}
  \centerfloat
<<fig_north_south_spreads, fig.height = 5, fig.width = 6>>=
local({
...
\footnote{In the estimates of the economic cost of the American Civil War in \textcite{GoldinLewis1975}, physical capital loss was the largest component of the direct cost of the war to the Confederacy \parencite[308]{GoldinLewis}}
