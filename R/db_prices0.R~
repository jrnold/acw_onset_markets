...
.DEPENDENCIES <-
    unname(sapply(c("merchants_magazine_us_paper_yields_2.csv",
                    "bankers_magazine_govt_state_loans_yields_2.csv",
                    "greenbacks.csv"),
                  get_findata_path))
...
bankers <- function() {
    bankers <-
        subset(FINDATA[["bankers_magazine_govt_state_loans_yields_2"]](),
