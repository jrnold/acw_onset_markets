...
This paper uses the number of news articles in the \textit{New York Times} about about a battle as a measure of the amount of information of a battle reaching the market.
...
\begin{equation}
  \begin{aligned}[t]
    w'_{t} &= \frac{1}{2}\sum_{i = 1}^{n_{t}} \frac{1}{\mathtt{page}_{i}} +  \frac{1}{2} \sum_{i = 1}^{n_{t - 1}} \frac{1}{\mathtt{page}_{j}} \\
