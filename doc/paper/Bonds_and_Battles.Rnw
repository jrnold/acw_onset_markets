...
This section answers these questions using the data on the prices and yields of U.S. and state government bonds traded in New York and three analyses: the yields of the bonds, the spread between Southern and  Northern state bonds, and the implied probability of war calculated by treating war as a default event. 
Based on these analyses, the market considered there to be negligible risk of war prior to the election of Lincoln in November 1860.
After the election and before Fort Sumter, the market implied a higher risk of war, but the implied risk was still low.

To assess financial market beliefs about the \textit{ex ante} risk of the  American Civil War, this paper uses the prices and yields of U.S. government and state, both northern and southern, bonds traded in New York City from 1855-1861.
The data consist of bonds issued by ten states (Georgia, Indiana, Kentucky, Louisiana, Missouri, North Carolina, Ohio, Pennsylvania and Virginia) and two bonds issued by the US Government (6s of 1868, 5s of 1874).
...
Prices of these bonds are available at an approximately weekly frequency from 1855 through the start of the war in April 1861.
All of these bonds are coupon bonds with longer maturities.
The bonds paid interest of 5--6 percent per annum semi-annually.
The U.S. bonds matured in 1868 and 1874 respectively, while the state bonds variously matured between 1869 and 1892.
%% \footnote{In many cases, the maturity of the bond was unclear; in that case the yield to maturity used is the expected value of the yield to maturity taken over the possible maturities of the bond. 
%%   See the data documentation for details.
%% }
The two U.S. bonds, the 6s of 1868 and the 5s of 1874, were the only two large bond issues of the U.S. outstanding at the start of the the civil war.%
\footnote{The terms 5s and 6s refer to bonds paying 5 percent and 6 percent interest, respectively.}
Between the War of 1812 and the Civil War, the U.S. government only periodically issued debt; the 6s of 1868 were issued in 1848 to pay for the Mexican-American War, while 5s of 1874 were issued in 1858 due to a funding shortfall as a result of a financial crisis, the Panic of 1857.
The state bonds included here are mostly southern and midwestern states which issued debt to fund infrastructure project, e.g. railroads and canals. 
During this period most New England states did not issue debt, with the notable exception of Massachusetts.
\footnote{
  ...
  However, the Massachusetts bonds were not regularly quoted in the \textit{Bankers' Magazine}.
}
...
From 1855 to October 1857, yields were largely stable.
The yields of state bonds were between 5--8 percent.
The yields of the U.S. 6s of 1868 were stable at ... to ... .
Note that this represented the lowest yield of U.S. bonds up to that point.

From October 1857 to January 1858, during the Panic of 1857, the yields of state and government bond spiked, in several cases, exceeding 10 percent.
...
So although yields increased in the panic, this should not be interpreted as representing an increase in war risk.
    
After the Panic of 1857, from February 1858 through mid 1860, yields of bonds were again low and stable.
The yields of bonds recovered to where they were before the Panic of 1857, and in several cases, e.g. Pennsylvania, were less than the yields pre-panic.
...
After Lincoln's victory in the election of 1860,%
\footnote{
  The election was held on November 6, 1860. Although the election was close, Lincoln's victory was known to be likely the next day, and certain by the 8th. CITE NYT ARTICLES.
  }
...
Prior to the election there was some slight increase in yields,%
\footnote{``The continued contraction of the banks, and the decrease in the specie reserve, caused some activity in the money market in the beginning of the month...'' \parencite{BankersMagazine1861}
p}
but the month before the election the \textit{Bankers' Magazine} wrote,
\begin{quote}
