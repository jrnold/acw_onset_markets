...
The price of bonds is the present discounted value of a stream of expected cash flows.
So the current price of a bond represents expectations aobut future payments given the information available at the time.
Changes in the information set on which those expectations are conditioned will change prices and yields.
...
\footnote{GDP was neither nor invented until WWI. Wealth was used as a measure of states' ability to pay their burden.}
...
After the initiation of the war, southern states ceased interest payments to northern creditors starting with the coupon payments due on  July 1st, 1861 \parencite[947]{BankersMagazine1861}[159]{BankersMagazine1862}.
...
For most bonds, there was a slight increase in yields in October.
This was due to both to and anticipation of the election result beginning of a recession.%
...
The is accompanied by monetary contraction and a shortage of specie that likley affected bond prices (Oct 25, 1860).
However, the `

   The market for Government and State loans during the month has been
   dull Prices hare In most instances tended downward and a material
   decline is perceptible in some of the most prominent securities The
   principal reasons for this seem to be the political excitement (October 25, 1860 p. 414)   

The market adjustment appears to have ben due to the Republican gubernatorial election in Pennsylvania on October 9.

\footnote{
  \begin{quote}
    The election in Pennsylvania early in October and the prospect
    which it gave of the election of the Republican candidate for
    President in November caused the timid to pause and towards the
    middle of the month the market was dull unsettled and declining
    but the decline for which the month is remarkable did not assume
    its real proportions until the last week (   
    
  \end{quote}
}

However, the market yield did not move greatly until after the election.
It is important to note that yields did not rise immediately after Licoln's election victory (as would occur with Fort Sumter), but rose over the cours of the following month, with some variability as to the timing between the different bonds.
...
However, political risk was the primary concern of the market. 
  ...
  The political complications in South Carolina had engendered a feeling of distrust in the stability of the present union of the States and public and private credit received a severe shock. (Nov 24, 1860) % http://books.google.com/books?id=KVwmAQAAIAAJ&pg=PA499

   The month has been a most disastrous one in the stock market At the
   beginning a slight firmness was perceptible in State securities but
   under the political complications It rapidly disappeared and the
   growing lightness of money precipitated a movement to sell which
   has enlarged itself into a regular panic
...
The market appeared to have anticipated the formal secession of states. %
...
The spread is essentially estimated as the difference between the mean yield of southern and northern bonds, but with a random walk prioron the value of the spread that smooths over time while still allowing for the sharp changes that are observed during key events.
