...
However, even in April 1860, the risk of war implied by the market was extremely low, and is estimated to be approximatley 5 percent.
...
The objective of this paper is to estimate the market's beliefs about the probability of the American Civil War in the period leading up to the war's initiation.
The prices (and yields) of bonds can be used for this purpose, because the price of a bond is the present discounted value of expected cash flows.
The price of a bond is,
\begin{equation}
  p = \sum_{i=1}^{n} E(c_{i} | \Omega) e^{-r_{t_{i}} t_{i}}
\end{equation}
where $p$ is the price of a bond (or generic asset) paying $\{c_{i} \}_{i=1}^{n}$ at times $\{t_{i}\}_{i=1}^{n}$ with discount factors $\{r_{t_{i}} \}_{i=1}^{n}$. 
$E(. | \Omega)$ is an expected value conditioned on the information at the current time.
This paper will use yields to maturity instead of prices.

For changes in prices to represent changes in the risk of war, the expectations about cashflows must be related to war and other factors which could change expectations about cashflows could controlled for.

EXPAND THIS

- bond prices are expectations
- yields are the inverse of prices
- more risk to cashflows, e.g. from default = lower prices, and higher yields.
- can attribute changes in prices to changes in beliefs about the expected probability of war to price changes if changes in war beliefs are plausibly the most important thing changing in this period: (1) period close to the war, and (2) check business magazines to see what factors are mentioned with respect to the price changes.
...
For investors holding U.S. government bonds, war and secession would have would reduce the ability of U.S. government to pay its debts by reducing potential revenue with the loss of the southern states and increasing debt to pay war expeditures.
Southern states accounted for 25 percent of the non-slave wealth of the United States \parencite[11]{Elder1865}.%
\footnote{GDP was neither nor invented until WWII. During that era, the census estimates of personal and property wealth was used as a measure of the total economy and ability to repay the debt.}
...
The Act of July 17, 1861, the first act passed by Congress to fund the war, and it authorized the issue of \$250 million in debt \parencite[44]{Treasury1863}.
Since  the debt on July 1, 1861 was 90 million \parencite[23]{Treasury1861}, this represented an increase in the U.S. debt of 178\%.
By comparison, the debt at the end of the War of 1816 was 127 million \parencite[29]{Elder1863} and 49 million in debt was issued to fund the Mexican American War.%
...
For investors holding southern state bonds, the immediate risk was that southern states would would default on interest payments.
After the initiation of the war, southern states ceased interest payments to northern creditors starting with the coupon payments due on  July 1st, 1861 \parencites[947]{BankersMagazine1861}[159]{BankersMagazine1862}.
...
\begin{quote}
 \dots the decline [in the price of Virginia, Tennessee and Missouri bonds] \dots was further stimulated by the political condition of the country and doubts as to the prompt payment of interest by these States.
\end{quote}
After Fort Sumter, concern over default on interest payments was primary reason cited for the decline in the prices of southern state bonds: ``These low values [prices of southern state bonds] have partly been caused by the fear that these States will not be disposed to provide for the payment of their semi annual interest in July next'' \parencite[947]{BankersMagazine1861}.
...
Additionally, although, at first the ability of the states to pay their debts was not much in doubt, an extended war would result in both more debt issued by southern states and wealth destroyed, both of which could affect the ability of the states to eventually pay the debt they had issued.
